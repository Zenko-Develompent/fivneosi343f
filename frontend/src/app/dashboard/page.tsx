        ...
        <div className={styles.aboutus}>
          ...
          <div className={styles.description}>
            ...
            <p className={styles.text}>
							<br/>Знакомьтесь, это Бегемоша — самый умный и добрый бегемот в мире программирования!<br/>
							Он помогает детям делать первые шаги в IT.<br/>
							Вместе с Бегемошей ваш ребенок научится писать настоящий код.<br/>
							И всё это — в игровой форме, без скучных правил и сложных терминов.<br/>
